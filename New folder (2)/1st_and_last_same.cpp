// Design a Finite Automata (FA) that accepts language L1, over
// S={a, b}, comprising of all strings (of length 4 or more) having
// first two characters same as the last two. Write a program to
// simulate this FA.
